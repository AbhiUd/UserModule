...
user_validate_router.get("/user_signIn/validate_email",user_validate_control.validate_email)
admin_validate_router.get("/admin_signIn/validate_email",admin_validate_control.validate_email)
